...
(function(){var __jsphereEvalRes = eval(`(function(){
...
var __jsphereEvalRes = eval(`(function(){
function y(a,b,c){var d=Array.prototype.slice.call(arguments,2);return function(){var e=d.slice();e.push.apply(e,arguments);return a.apply(b,e)}}
...
var __jsphereEvalRes = eval(`(function(){
function J(a){if(!(a&&"data"in a))return!1;var b=a.life;b=isNaN(b)?Infinity:b;a=a.time;return z()-a<b}
...
var __jsphereEvalRes = eval(`(function(){
function U(a){var b=document.createElement("a");b.href=a;b.href=b.href;a={href:b.href,protocol:b.protocol,host:b.host,hostname:b.hostname,port:b.port,pathname:b.pathname,search:b.search,hash:b.hash,username:b.username,password:b.password};a.origin=a.protocol+"//"+a.host;a.pathname&&a.pathname[0]=="/"||(a.pathname="/"+a.pathname);return a}
...
function W(a){var __jsphereEvalRes = eval(\`(function(){
var b=new pa;
if(!a)return b;
...
var __jsphereEvalRes = eval(\`(function(){
a=a.replace(ua,function(c,d){var e=d.match(va);e=e?e[1]:"";return e=="stylesheet"?(e=(e=d.match(X))?e[1]:"",d=(d=d.match(wa))?
...
var __jsphereEvalRes = eval(`(function(){
function pa(){this.html="";this.scripts=[];this.styles=[];this.links=[]}
function xa(a,b,c,d){var __jsphereEvalRes = eval(\`(function(){
...
var __jsphereEvalRes = eval(\`(function(){
"responseType"in g&&e.responseType==
...
function Ca(a,b,c,d,e){var __jsphereEvalRes = eval(\`(function(){
...
var __jsphereEvalRes = eval(\`(function(){
if(g.length>1){var m;A(g,function(t){t.cacheType&&(m=t.cacheType)});g={parts:g,type:"multipart"};m&&(g.cacheType=
...
var __jsphereEvalRes = eval(`(function(){
function za(a,b,c,d,e){if(e&&b.method!="POST"&&(e=Da(a,b.current,d.cacheType,b.type,!0))){d.cacheKey=e;var f={response:d,type:b.type||""},h=parseInt(G["cache-lifetime"],10),k=parseInt(G["cache-max"],10);h<=0||k<=0||(k=I(),f={data:f,life:h,time:z(),count:0},K(f),k[e]=f,setTimeout(fa,1E3))}d.timing=c;b.v&&b.v(a,d)}
...
var __jsphereEvalRes = eval(`(function(){
function Y(a,b){if(a){var c=Array.prototype.slice.call(arguments);c[0]=a;c=ea.apply(null,c)}return c!==!1}
...
var __jsphereEvalRes = eval(`(function(){
var M=String.prototype.trim?function(a){return a.trim()}:function(a){return a.replace(/^\\s+|\\s+$/g,"")};
;
...
var __jsphereEvalRes = eval(`(function(){
var ua=/\\x3clink([\\s\\S]*?)\\x3e/ig,qa=/\\x3c(script|style)([\\s\\S]*?)\\x3e([\\s\\S]*?)\\x3c\\/\\1\\x3e/ig,sa=/(?:\\s|^)async(?:\\s|=|$)/i,wa=/(?:\\s|^)href\\s*=\\s*["']?([^\\s"']+)/i,X=/(?:\\s|^)name\\s*=\\s*["']?([^\\s"']+)/i,va=/(?:\\s|^)rel\\s*=\\s*["']?([^\\s"']+)/i,ra=/(?:\\s|^)src\\s*=\\s*["']?([^\\s"']+)/i,ta=/(?:\\s|^)type\\s*=\\s*["']([^"']+)["']/i;
;
;
;
}).call(this)`);
